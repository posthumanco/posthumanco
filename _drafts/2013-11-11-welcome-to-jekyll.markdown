...
<button class="tiny primary">Tiny Primary</button>
<button class="small secondary">Small Secondary</button>
<button class="alert">Standard Alert</button>
<button class="large disabled">Large Disabled</button>
<button class="large expand primary">Large Expand Primary</button>